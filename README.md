...
Build do frontend.
Validacao do Docker Compose com docker compose config.
Build das imagens Docker.
Subida integrada de db e backend.
Smoke test em http://localhost:5000/health.
...
Criacao do backend com Express.
Criacao das rotas principais da API.
Criacao do banco PostgreSQL via database/init.sql.
Criacao do frontend React com layout administrativo.
Criacao da tela de login baseada no exemplo da aula.
Implementacao dos botoes funcionais.
Criacao dos Dockerfiles.
Criacao do Docker Compose.
Criacao dos testes com Jest e Supertest.
Criacao do workflow GitHub Actions.
Validacao com npm test e npm run build.
Implementacao do CRUD de medicos.
Melhoria do agendamento com paciente digitado, validacao de data e conflito de horario.
Implementacao de status das consultas: confirmar, concluir e cancelar.
Criacao de pagina dedicada para cadastro de paciente.
Implementacao da edicao de pacientes pela mesma pagina de cadastro.
Refatoracao leve removendo imports e estilos nao utilizados.
Commits sugeridos
